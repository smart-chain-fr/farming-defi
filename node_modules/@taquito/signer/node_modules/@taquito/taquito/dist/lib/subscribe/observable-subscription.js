...
var ObservableSubscription = /** @class */ (function () {
    function ObservableSubscription(obs, shouldRetry, retries, delayInMS) {
        ...
        }), this.shouldRetry ? operators_1.retryWhen(function (errors) { return errors.pipe(operators_1.take(retries)); }) : operators_1.tap(), operators_1.catchError(function () { return rxjs_1.timer(delayInMS); }))
            .subscribe();
    }
