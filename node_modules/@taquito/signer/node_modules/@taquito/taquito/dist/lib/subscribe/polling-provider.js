...
var PollingSubscribeProvider = /** @class */ (function () {
    ...
    PollingSubscribeProvider.prototype.subscribe = function (_filter) {
        return new observable_subscription_1.ObservableSubscription(this.newBlock$.pipe(operators_1.pluck('hash')), this.context.config.shouldObservableSubscriptionRetry, this.context.config.observableSubscriptionRetries, this.context.config.observableSubscriptionRetryDelay);
    };
    PollingSubscribeProvider.prototype.subscribeOperation = function (filter) {
        return new observable_subscription_1.ObservableSubscription(this.newBlock$.pipe(applyFilter(filter)), this.context.config.shouldObservableSubscriptionRetry, this.context.config.observableSubscriptionRetries, this.context.config.observableSubscriptionRetryDelay);
    };
