    ...
    ***************************************************************************** */
                            ...
                            return [4 /*yield*/, Promise.all(keysBatch.map(function (keyToEncode) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 2:
                                                ex_2 = _a.sent();
                                                if (ex_2 instanceof httpUtils.HttpResponseError && ex_2.status === httpUtils.STATUS_CODE.NOT_FOUND) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            constants = _a.sent();
                            confirmationPollingInterval = BigNumber__default['default'].sum(constants.time_between_blocks[0], new BigNumber__default['default'](constants.delay_per_missing_endorsement)
    ...
    var ObservableSubscription = /** @class */ (function () {
        function ObservableSubscription(obs, shouldRetry, retries, delayInMS) {
            ...
            }), this.shouldRetry ? operators.retryWhen(function (errors) { return errors.pipe(operators.take(retries)); }) : operators.tap(), operators.catchError(function () { return rxjs.timer(delayInMS); }))
                .subscribe();
        }
    ...
    var PollingSubscribeProvider = /** @class */ (function () {
        ...
        PollingSubscribeProvider.prototype.subscribe = function (_filter) {
            return new ObservableSubscription(this.newBlock$.pipe(operators.pluck('hash')), this.context.config.shouldObservableSubscriptionRetry, this.context.config.observableSubscriptionRetries, this.context.config.observableSubscriptionRetryDelay);
        };
