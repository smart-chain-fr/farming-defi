...
import { distinctUntilChanged, map, takeWhile, tap, shareReplay, filter, first, switchMap, distinctUntilKeyChanged, timeoutWith, startWith, concatMap, mapTo, switchMapTo, takeUntil, retryWhen, take, catchError, pluck, publishReplay, refCount } from 'rxjs/operators';
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.signer.publicKeyHash()];
                    case 1: return [4 /*yield*/, _a.apply(this, [_l.sent()])];
                    case 2:
                    ...
                    case 8: return [4 /*yield*/, _g.apply(void 0, [_l.sent()])];
                    case 9:
                        _f.apply(_e, [_l.sent()]);
                        return [3 /*break*/, 14];
                    case 10:
                    ...
                    case 17:
                        ...
                        return [7 /*endfinally*/];
                    case 18: return [2 /*return*/, this.createEstimate({ operation: operations })];
                }
            });
        });
    };
...
var BigMapAbstraction = /** @class */ (function () {
     ...
     *
     */
    BigMapAbstraction.prototype.getMultipleValues = function (keysToEncode, block) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.provider.getBigMapKeysByID(this.id.toString(), keysToEncode, this.schema, block)];
            });
        });
    };
...
var RpcContractProvider = /** @class */ (function (_super) {
     ...
     *
     */
    RpcContractProvider.prototype.getBigMapKeysByID = function (id, keys, schema, block) {
        return __awaiter(this, void 0, void 0, function () {
            var bigMapValues, val, ex_1, level_1, header, batchSize, position, results, keysBatch, _a, i;
            var _b, _c, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        bigMapValues = Object((_b = {}, _b[keys[0]] = undefined, _b));
                        if (!(keys.length === 1)) return [3 /*break*/, 5];
                        val = void 0;
                        _e.label = 1;
                    case 1:
                        _e.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.getBigMapKeyByID(id, keys[0], schema, block)];
                    case 2:
                        val = _e.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        Object.assign(bigMapValues, (_c = {}, _c[keys[0]] = val, _c));
                        return [3 /*break*/, 12];
                    case 5:
                        if (!block) return [3 /*break*/, 6];
                        level_1 = block;
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.context.rpc.getBlock()];
                    case 7:
                        header = (_e.sent()).header;
                        level_1 = header.level;
                        _e.label = 8;
                    case 8:
                        batchSize = 5;
                        position = 0;
                        ...
                        _e.label = 9;
                    case 9:
                        if (!(position < keys.length)) return [3 /*break*/, 11];
                        keysBatch = keys.slice(position, position + batchSize);
                        _a = [results];
                        return [4 /*yield*/, Promise.all(keysBatch.map(function (keyToEncode) { return __awaiter(_this, void 0, void 0, function () {
                                var ex_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 2, , 3]);
                                            return [4 /*yield*/, this.getBigMapKeyByID(id, keyToEncode, schema, level_1)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                        case 2:
                                            ex_2 = _a.sent();
                                            if (ex_2 instanceof HttpResponseError && ex_2.status === STATUS_CODE.NOT_FOUND) {
                                                keyToEncode = undefined;
                                            }
                                            else {
                                                throw ex_2;
                                            }
                    ...
                    case 10:
                        results = __spread.apply(void 0, _a.concat([_e.sent()]));
                        position += batchSize;
                        return [3 /*break*/, 9];
                    case 11:
                        for (i = 0; i < results.length; i++) {
                            Object.assign(bigMapValues, (_d = {}, _d[keys[i]] = results[i], _d));
                        }
                        _e.label = 12;
                    case 12: return [2 /*return*/, bigMapValues];
                }
            });
        });
    };
...
var ObservableSubscription = /** @class */ (function () {
    function ObservableSubscription(obs, shouldRetry, retries, delayInMS) {
        var _this = this;
        ...
        }), this.shouldRetry ? retryWhen(function (errors) { return errors.pipe(take(retries)); }) : tap(), catchError(function () { return timer(delayInMS); }))
            .subscribe();
    }
...
var PollingSubscribeProvider = /** @class */ (function () {
    function PollingSubscribeProvider(context, POLL_INTERVAL, retries, delayInMS) {
        var _this = this;
    ...
    PollingSubscribeProvider.prototype.subscribe = function (_filter) {
        return new ObservableSubscription(this.newBlock$.pipe(pluck('hash')), this.context.config.shouldObservableSubscriptionRetry, this.context.config.observableSubscriptionRetries, this.context.config.observableSubscriptionRetryDelay);
    };
    PollingSubscribeProvider.prototype.subscribeOperation = function (filter) {
        return new ObservableSubscription(this.newBlock$.pipe(applyFilter(filter)), this.context.config.shouldObservableSubscriptionRetry, this.context.config.observableSubscriptionRetries, this.context.config.observableSubscriptionRetryDelay);
    };
